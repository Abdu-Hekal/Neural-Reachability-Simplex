...
linear programming problems via the Neural-Reachability and Interior-Point methods.
...
def linprog_verbose_callback(res):
    ...
    if status:
        print('--------- Neural-Reachability Early Exit -------\n'.format(nit))
        print('The simplex method exited early with status {0:d}'.format(status))
        print(message)
    elif complete:
        print('--------- Neural-Reachability Complete --------\n')
